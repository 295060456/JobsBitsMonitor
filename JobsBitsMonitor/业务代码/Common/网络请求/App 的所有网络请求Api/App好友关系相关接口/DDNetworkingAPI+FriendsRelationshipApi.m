...
//            request.keepType=ZBResponseKeepNone;
        ...
        if ([responseObject isKindOfClass:NSDictionary.class]) {
            ...
            [WHToast toastMsg:[@"异常接口" stringByAppendingString:NSObject.friendUrlselectUrlGET.funcName]];
        }
...
//            request.keepType=ZBResponseKeepNone;
        ...
        if ([responseObject isKindOfClass:NSDictionary.class]) {
            ...
            [WHToast toastMsg:[@"异常接口" stringByAppendingString:NSObject.userFriendListGET.funcName]];
        }
    }failure:^(NSError * _Nullable error){
        NSLog(@"error = %@",error);
    }finished:^(id  _Nullable responseObject,
