...
//            request.keepType=ZBResponseKeepNone;
        ...
        if ([responseObject isKindOfClass:NSDictionary.class]) {
            ...
            [WHToast toastMsg:[@"异常接口" stringByAppendingString:NSObject.userFocusAddPOST.funcName]];
        }
...
//            request.keepType=ZBResponseKeepNone;
        ...
        if ([responseObject isKindOfClass:NSDictionary.class]) {
            ...
            [WHToast toastMsg:[@"异常接口" stringByAppendingString:NSObject.userFocusDeleteGET.funcName]];
        }
    }failure:^(NSError * _Nullable error){
        NSLog(@"error = %@",error);
...
//            request.keepType=ZBResponseKeepNone;
        ...
        if ([responseObject isKindOfClass:NSDictionary.class]) {
            ...
            [WHToast toastMsg:[@"异常接口" stringByAppendingString:NSObject.userFocusListGET.funcName]];
        }
    }failure:^(NSError * _Nullable error){
        NSLog(@"error = %@",error);
        if (failureBlock) {
