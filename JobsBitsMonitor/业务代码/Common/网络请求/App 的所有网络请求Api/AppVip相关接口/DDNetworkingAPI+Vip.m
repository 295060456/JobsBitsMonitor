...
//            request.keepType=ZBResponseKeepNone;
        ...
        if ([responseObject isKindOfClass:NSDictionary.class]) {
            ...
            [WHToast toastMsg:[@"异常接口" stringByAppendingString:NSObject.vipApplyGET.funcName]];
        }
...
//    NSDictionary *headers = @{};
    ...
    //            request.keepType=ZBResponseKeepNone;
        ...
        if ([responseObject isKindOfClass:NSDictionary.class]) {
            ...
            [WHToast toastMsg:[@"异常接口" stringByAppendingString:NSObject.vipListGET.funcName]];
        }
    }failure:^(NSError * _Nullable error){
        NSLog(@"error = %@",error);
    }finished:^(id  _Nullable responseObject,
...
//            request.keepType=ZBResponseKeepNone;
        ...
        if ([responseObject isKindOfClass:NSDictionary.class]) {
            ...
            [WHToast toastMsg:[@"异常接口" stringByAppendingString:NSObject.vipSelfGET.funcName]];
        }
    }failure:^(NSError * _Nullable error){
        NSLog(@"error = %@",error);
    }finished:^(id  _Nullable responseObject,
