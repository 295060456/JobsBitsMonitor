...
//            request.keepType=ZBResponseKeepNone;
        ...
        if ([responseObject isKindOfClass:NSDictionary.class]) {
            ...
            [WHToast toastMsg:[@"异常接口" stringByAppendingString:NSObject.commentAddPOST.funcName]];
        }
...
//            request.keepType=ZBResponseKeepNone;
        ...
        if ([responseObject isKindOfClass:NSDictionary.class]) {
            ...
            [WHToast toastMsg:[@"异常接口" stringByAppendingString:NSObject.commentAllListGET.funcName]];
        }
    }failure:^(NSError * _Nullable error){
        NSLog(@"error = %@",error);
    }finished:^(id  _Nullable responseObject,
...
//            request.keepType=ZBResponseKeepNone;
        ...
        if ([responseObject isKindOfClass:NSDictionary.class]) {
            ...
            [WHToast toastMsg:[@"异常接口" stringByAppendingString:NSObject.commentListGET.funcName]];
        }
    }failure:^(NSError * _Nullable error){
        NSLog(@"error = %@",error);
    }finished:^(id  _Nullable responseObject,
